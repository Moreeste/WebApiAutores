...
namespace WebApiAutores.Servicios
{
    public class FacturasHostedService : IHostedService
    {
        ...
        {
            context.Database.ExecuteSqlRaw("execute SetearMalaPaga");
        }
        ...
        private static void EmitirFacturas(ApplicationDbContext context)
        {
            ...
            if (!facturasDelMesYaFueronEmitidas)
            {
                ...
                context.Database.ExecuteSqlInterpolated($"execute CreacionFacturas {fechaInicio.ToString("yyyy-MM-dd")}, {fechaFin.ToString("yyyy-MM-dd")}");
            }
        }
    }
}
